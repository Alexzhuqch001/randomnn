...
train_data=TrainingData_File;%load(TrainingData_File);
T=train_data(:,1)';
P=train_data(:,2:size(train_data,2))';
clear train_data;                                   %   Release raw training data array

%%%%%%%%%%% Load testing dataset
test_data=TestingData_File;%load(TestingData_File);
TV.T=test_data(:,1)';
...
%ANN_alltrainlabel=T;
%save ANN_alltrainlabel ANN_alltrainlabel

%ANN_alltestlabel=TV.T;

%save ANN_alltestlabel ANN_alltestlabel
...
Testoutput_temp=TY;
save Testoutput_temp Testoutput_temp
%%%%%%%%%%%%%%%%%% Kernel Matrix %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
